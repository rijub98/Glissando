        ...
        <div class="container">
            ...
            <div class="grid-container">
                <?php
                    ...
                    $sql = 'SELECT * FROM albums,artist WHERE albums.album_id=' . $albumID . ' AND albums.artist_id=artist.artist_id ORDER BY album_name ASC';
                    ...
                    mysqli_close($con);
                ?>
                <form action="../php/edit-albums.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-70">
                            <input type="text" name="album_name" id="album_name" value="<?php echo $album_name;?>" class="form-control" style="color: black;" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-30">
                        ...
                        <div class="col-70">
                            <select name="artist_id" id="artist_id" class="form-control" required>
                                ...
                                <?php
                                    ...
                                    <option value="<?php echo $subjectData['artist_id'];?>" <?php 
                                                                                                if($subjectData['artist_id'] == $artist_id){
                                                                                                    echo "selected";
                                                                                                }
                                                                                            ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-70">
                            <input type="date" name="album_release_date" id="album_release_date" value="<?php echo $album_release_date;?>" style="margin-top: 7%; margin-left: 20%; color: black;" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-30">
                        ...
                        <div class="col-70">
                            <input type="text" name="album_genre" id="album_genre" value="<?php echo $album_genre;?>" class="form-control" style="color: black;" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-30">
                    ...
                    <div class="row">
                        <input type="submit" name="upload" value="Update Album">
                    </div>
                </form>
            </div>
        </div>
