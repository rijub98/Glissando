        ...
        <div class="container">
            ...
            <div class="grid-container">
                <?php
                    ...
                    mysqli_close($con);
                ?>
                <form action="../php/edit-artist.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-70">
                            <input type="text" name="artist_name" id="artist_name" value="<?php echo $artistName;?>" class="form-control" style="color: black;" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-30">
                        ...
                        <div class="col-70">
                        <textarea type="text" name="artist_bio" id="artist_bio" class="form-control" style="color: black;" rows="10" cols="50"><?php echo $artistBio;?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-30">
                    ...
                    <div class="row">
                        <input type="submit" name="upload" value="Update Artist">
                    </div>
                </form>
            </div>
        </div>
