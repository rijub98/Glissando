        ...
        <div class="container">
            ...
            <div class="container container1">
                <?php
                    ...
                    $sql = "select * from artist ORDER BY artist_name ASC";     // Selects the artists details in ascending order
                    $artistImageRelativeDir = "../uploads/image/artist/";       // The path of the image is stored in this variable                       
                    ...
                    while($row = mysqli_fetch_array($res))
                    {
                        if (empty($row['artist_name'])) {
                            ...
                            $dyn_table .= '<img src="' . $artistImageRelativeDir . $row['artist_photo'] . '" height="150" width="150">';
                            $dyn_table .= PHP_EOL;
                            $dyn_table .= "{$row['artist_name']}";
                            $dyn_table .= '</td>';
                            $dyn_table .= '<td align="justify">';
                            $dyn_table .=  $row['artist_bio'];
                            ...
                            if($is_admin){
                                ...
                                $dyn_table .= '<td align="center">';
                                $dyn_table .= '<form>';
                                $dyn_table .= '<input type="button" class="button editbutton" style="text-align: center;" value="Edit" onclick="editartist(' . $artistID .')">';
                                $dyn_table .= '</form>';

                                $dyn_table .= '<form>';
                                $dyn_table .= '<input type="button" class="button deletebutton" value="Delete" onclick="deleteartist(' . $artistID .')">';
                                $dyn_table .= '</form>';
                            }
                            $dyn_table .= '</td></tr>';
                        }
